...
import './App.css';
import { ScriptPluginSelectionBox, ScriptClientSelectionBox } from './controls/ScriptPluginSelectionBox';
//import { ScriptClientSelectionBox } from './controls/ScriptPluginSelectionBox';
        ...
        <main>
            <VSCodePanels>
                ...
                <VSCodePanelView id="view-4" style={{ flexDirection: 'column' }}>
                    <ScriptClientSelectionBox name="client_frame_timings" onChange={handleClientSelection} />
                ...
                <VSCodePanelView id="view-7">
                    <ScriptPluginSelectionBox name="handle_counts" onChange={handlePluginSelection} />
                    <MinecraftStatisticLineChart
